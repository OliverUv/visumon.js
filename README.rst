...
Visumon will be an interactive game-of-life like visualization written in
javascript, made to connect to a single html5 canvas tag.

Visumon will support having any number of states per cell, each with different
...
Interaction with Visumon will be entirely based on detecting when the mouse is
